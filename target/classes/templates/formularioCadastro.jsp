...
<div class="container">
	...
	<div class="navegacao-abas">
		<ul class="nav nav-tabs">
			...
			<li><a href="#professor" data-toggle="tab">Educador Físico</a></li>
				...
				<form class="form-horizontal" method="post" action="salvarCliente" >
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="clearfix">
						<h1 class="panel-title mov-titulo-panel pull-left">Novo Usuário</h1>
						<a class="btn btn-link mov-link-panel pull-right" href="#">Pesquisa de Usuário</a>
					  </div>
						</div>
						<div class="panel-body">
							<input type="hidden" id="codigo" /> <!-- Código escondido -->
						...
						<div class="form-group" >
							<label for="confirmacaoSenha" class="col-sm-2 control-label">Confirmação</label>
							<div class="col-sm-4">
		...
		<div class="tab-pane fade" id="professor">
			<form class="form-horizontal" method="post" action="salvarProfessor"  >
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="clearfix">
					<h1 class="panel-title mov-titulo-panel pull-left">Novo Educador Físico</h1>
					<a class="btn btn-link mov-link-panel pull-right" href="#">Educador Físico</a>
				  </div>
					</div>
					<div class="panel-body">
						<input type="hidden" id="codigo" /> <!-- Código escondido -->
						...
						<div class="form-group" >
							<label for="confirmacaoSenhaP" class="col-sm-2 control-label">Confirmação</label>
							<div class="col-sm-4">
			...
			<form class="form-horizontal" method="post" action="salvarNutricionista" >
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group" >
							<label for="confirmacaoSenhaN" class="col-sm-2 control-label">Confirmação</label>
							<div class="col-sm-4">
